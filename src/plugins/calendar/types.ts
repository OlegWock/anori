...
import { z } from "zod";
import { DEFAULT_CALENDAR } from "./calendar-adapter";
...
export const calendarWidgetConfigSchema = z.object({
  ...
  // predate this field. See SUPPORTED_CALENDARS in calendar-adapter.ts.
  calendar: z.string().default(DEFAULT_CALENDAR),
});
