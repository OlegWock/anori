...
import FluentPlugDisconnected48Regular from "~icons/fluent/plug-disconnected-48-regular?raw";
...
const builtinIconSvgsBySourceId = {
  ...
  "fluent:plug-disconnected-48-regular": FluentPlugDisconnected48Regular,
