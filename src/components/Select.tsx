...
const RadixSelectScrollUpButton = lazy(() =>
  import("@radix-ui/react-select").then((m) => ({ default: m.SelectScrollUpButton })),
);
const RadixSelectViewport = lazy(() => import("@radix-ui/react-select").then((m) => ({ default: m.SelectViewport })));
const RadixSelectScrollDownButton = lazy(() =>
  import("@radix-ui/react-select").then((m) => ({ default: m.SelectScrollDownButton })),
);
...
const RadixSelectItemIndicator = lazy(() =>
  import("@radix-ui/react-select").then((m) => ({ default: m.SelectItemIndicator })),
);
